...
void addNode()
{
    ...
    else
    {
        ...
        {                       // step 1.c: traverse the lst to find the correct position
...
void deleteNode()
{
    ...
    if (current == NULL)
    {
        cout << "\033[31mThe record with roll number " << rollNo << "no found\033[0m" << endl;
        return;
    }
...
void traverse()
{
    ...
    {
        cout << "\nRecord in descending order of roll nummber are:" << endl;
